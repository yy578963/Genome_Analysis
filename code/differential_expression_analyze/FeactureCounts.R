...
data_R7_1 = read.table("SRR24516462.count", header = TRUE)
R7_1 = data_R7_1[,7]
data_R7_2 = read.table("SRR24516463.count", header = TRUE)
R7_2 = data_R7_2[,7]
data_R7_3 = read.table("SRR24516464.count", header = TRUE)
R7_3 = data_R7_3[,7]

# HP126 to R7 

data_HP126_1 = read.table("SRR24516459.count", header = TRUE)
HP126_1 = data_HP126_1[,7]
data_HP126_2 = read.table("SRR24516460.count", header = TRUE)
HP126_2 = data_HP126_2[,7]
data_HP126_3 = read.table("SRR24516461.count", header = TRUE)
HP126_3 = data_HP126_3[,7]
...
data_DV3_1 = read.table("SRR24516456.count", header = TRUE)
DV3_1 = data_DV3_1[,7]
data_DV3_2 = read.table("SRR24516457.count", header = TRUE)
DV3_2 = data_DV3_2[,7]
data_DV3_3 = read.table("SRR24516458.count", header = TRUE)
DV3_3 = data_DV3_3[,7]
