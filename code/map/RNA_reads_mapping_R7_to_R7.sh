...
#SBATCH -n 2
#SBATCH -t 08:00:00
#SBATCH -J tyy_RNA_reads_mapping_R7_to_R7
#SBATCH --mail-type=ALL
#SBATCH --mail-user yuyan.teng.2303@student.uu.se
#SBATCH --output=RNA_reads_mapping_R7_to_R7.out
...
do
    ...
    | samtools sort - -o $home_path/RNA_data/mapped_data/R7_to_R7/SRR245164"$i".bam
    samtools index $home_path/RNA_data/mapped_data/R7_to_R7/SRR245164"$i".bam
done
