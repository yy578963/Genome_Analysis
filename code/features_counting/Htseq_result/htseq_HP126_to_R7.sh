...
#SBATCH -n 2
#SBATCH -t 08:00:00
#SBATCH -J tyy_htseq_HP126_to_R7
#SBATCH --mail-type=ALL
#SBATCH --mail-user yuyan.teng.2303@student.uu.se
#SBATCH --output=htseq_HP126_to_R7.out
...
for i in {59..61};
do
    htseq-count -f bam -r pos -t CDS -i ID $home_path/RNA_data/mapped_data/HP126_to_R7/SRR245164"$i".bam \
